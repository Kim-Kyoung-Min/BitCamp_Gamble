      ...
      try {
         ...
         while (cnt1 < 29 || cnt2 < 29 || cnt3 < 29 || cnt4 < 29 || cnt5 < 29) {
            ...
            if (cnt1 + runningNum1 < 29)
               ...
               cnt1 = 29;
            track[0][cnt1] = "♘";
            for (int i = cnt1 - runningNum1; i < cnt1; ++i)
               track[0][i] = "          ";
            // ------------------------------------------------------
            ...
            if (cnt2 + runningNum2 < 29)
               ...
               cnt2 = 29;
            track[1][cnt2] = "♞";
            for (int i = cnt2 - runningNum2; i < cnt2; ++i)
               track[1][i] = "          ";
            // ------------------------------------------------------
            ...
            if (cnt3 + runningNum3 < 29)
               ...
               cnt3 = 29;
            track[2][cnt3] = "♘";
            for (int i = cnt3 - runningNum3; i < cnt3; ++i)
               track[2][i] = "          ";
            // ---------------------------------------------------
            ...
            if (cnt4 + runningNum4 < 29)
               ...
               cnt4 = 29;
            track[3][cnt4] = "♞";
            for (int i = cnt4 - runningNum4; i < cnt4; ++i)
               track[3][i] = "          ";
            // -----------------------------------------------------
            ...
            if (cnt5 + runningNum5 < 29)
               ...
               cnt5 = 29;
            track[4][cnt5] = "♘";
            for (int i = cnt5 - runningNum5; i < cnt5; ++i)
               track[4][i] = "          ";
